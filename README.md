...
- [The Processing family of languages (Processing, P5.js, Processing Python](https://processing.org/)
- [KodeLife](https://hexler.net/kodelife)

## Custom tools tools for visuals used by other live coders
- [La Habra](https://github.com/sarahghp/la-habra)
- [L5](https://l5lua.org/)
- [Viswasm](https://github.com/Blood-Bank-Global/vizwasm)
- [murrelet](https://github.com/jessstringham/murrelet)

## Custom tools used for Messica Arson performances
